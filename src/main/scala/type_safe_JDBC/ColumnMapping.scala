...
object ColumnMapping {
  ...
  given [C <: String]: ColumnMapping[JDBCType.TL.NotSupported, JDBCNullability.TL.NonNullable, C] with {
    type Result = String
    override def reader: JDBCReader[String] = JDBCReader.string
  }

  given [C <: String]: ColumnMapping[JDBCType.TL.NotSupported, JDBCNullability.TL.Nullable, C] with {
    type Result = Option[String]
    override def reader: JDBCReader[Result] = JDBCReader.string.toOption
  }
