...
object StructuralTypes {
  ...
  object Record {
    ...
    // jedi master: return Record(fields.toMap)
    ...
    def makeImpl(fields: Expr[Seq[(String, Any)]])(using q: Quotes): Expr[Record] = {
      ...
      // if you want to add multiple fields, just refine further from the last one -- like below
      //      val newFieldName = "color"
      //      val newFieldType = TypeRepr.of[Int]
      //      val newRefinement = Refinement(refinement, newFieldName, newFieldType)
